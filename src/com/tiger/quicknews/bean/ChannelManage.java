...
public class ChannelManage {
    ...
    static {
        ...
        defaultUserChannels.add(new ChannelItem(2, "python", 2, 1));
        defaultUserChannels.add(new ChannelItem(3, "JS", 3, 1));
        defaultUserChannels.add(new ChannelItem(4, "IOS", 4, 1));
        defaultUserChannels.add(new ChannelItem(5, "美女", 5, 1));
        defaultUserChannels.add(new ChannelItem(6, "笑话", 6, 1));
        // defaultUserChannels.add(new ChannelItem(7, "图片", 1, 0));
        /*defaultOtherChannels.add(new ChannelItem(7, "", 1, 0));
        defaultOtherChannels.add(new ChannelItem(8, "", 2, 0));*/
        defaultOtherChannels.add(new ChannelItem(9, "web开发", 3, 0));
        defaultOtherChannels.add(new ChannelItem(10, "Java", 4, 0));
