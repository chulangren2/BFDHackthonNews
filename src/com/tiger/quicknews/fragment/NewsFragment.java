...
public class NewsFragment extends BaseFragment implements
	...
	protected void initView() {
		...
		// View headView =
		// LayoutInflater.from(getActivity()).inflate(R.layout.head_item, null);
	...
	private void loadLocalData() {
		...
		if(channelName != null && ! channelName.equals(lastChannel)){
			...
			String result = getMyActivity().getCacheStr(channelName + currentPagte);
	...
	public void getResult(String result) {
		 ...
		 */
		/*
		 * if (index == 0 && list.size() >= 4) { initSliderLayout(list); } else
	...
	private NewModle getNewModle(JSONObject jsonObject) {
		...
		newModle.setDigest("我们都是爱学习的好孩子");
		newModle.setDocid(docid);
		newModle.setImgsrc("http://cms-bucket.nosdn.127.net/56ce9e7149104616a98a0a47de0e904e20160707113808.png");
